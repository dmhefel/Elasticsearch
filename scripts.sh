...
python load_es_index.py --index_name new_sbert_custom_idx --wapo_path pa5_data/with_avg_sbert
python load_es_index.py --index_name doc2vec_idx --wapo_path pa5_data/with_doc2vec.jl
